...
/*ADD ROOM DATA*/
INSERT INTO ROOM(r_num, c_Ssn, r_description, r_price, r_beds, r_capacity, r_name, r_floor)
VALUES(201, 501602703, 'Two twin beds, mini-fridge, flatscreen TV', 150, 2, 4, 'Value Suite', 2);
INSERT INTO ROOM(r_num, c_Ssn, r_description, r_price, r_beds, r_capacity, r_name, r_floor)
VALUES(304, 233200166, 'One queen bed, full kitchen, complimentary bar', 300, 1, 3, 'Deluxe Suite', 3);
INSERT INTO ROOM(r_num, c_Ssn, r_description, r_price, r_beds, r_capacity, r_name, r_floor)
VALUES(508, 999888777, 'One king bed, flatscreen TV, complimentary room service', 500, 1, 2, 'Honeymoon Suite', 5);

/*ADD RESERVATION DATA*/
INSERT INTO RESERVATION (RES_NUM,R_SSN,CHECKIN_DATE,CHECKOUT_DATE,R_NUM,GUEST_USERNAME,checked_in, checked_out)
VALUES(0,321321321,'2020-11-04','2020-11-08','201','TErvin', 0, 1);
INSERT INTO RESERVATION (RES_NUM,R_SSN,CHECKIN_DATE,CHECKOUT_DATE,R_NUM,GUEST_USERNAME, CHECKED_IN, CHECKED_OUT)
VALUES(1,'878656434','2020-11-01','2020-11-10','304','RDunn', 0, 1);
INSERT INTO RESERVATION (RES_NUM,R_SSN,CHECKIN_DATE,CHECKOUT_DATE,R_NUM,GUEST_USERNAME, CHECKED_IN, CHECKED_OUT)
VALUES(2,'666777888','2020-12-20','2020-12-27','508','BHolt', null, null);
INSERT INTO RESERVATION (RES_NUM,R_SSN,CHECKIN_DATE,CHECKOUT_DATE,R_NUM,GUEST_USERNAME, CHECKED_IN, CHECKED_OUT)
VALUES(3,'321321321','2020-11-17','2020-11-18','201','LSimpson', 0, 1);
INSERT INTO RESERVATION (RES_NUM,R_SSN,CHECKIN_DATE,CHECKOUT_DATE,R_NUM,GUEST_USERNAME, CHECKED_IN, CHECKED_OUT)
VALUES(4,'666777888','2020-11-23','2020-11-28','304','MFork', null, null);
INSERT INTO RESERVATION (RES_NUM,R_SSN,CHECKIN_DATE,CHECKOUT_DATE,R_NUM,GUEST_USERNAME, CHECKED_IN, CHECKED_OUT)
VALUES(5,'878656434','2020-12-04','2020-12-04','508','TErvin', null, null);
INSERT INTO RESERVATION (RES_NUM,R_SSN,CHECKIN_DATE,CHECKOUT_DATE,R_NUM,GUEST_USERNAME, CHECKED_IN, CHECKED_OUT)
VALUES(6,'321321321','2020-12-06','2020-12-12','201','BHolt', null, null);
